...
import { NavPane, NavPaneItem, Text, TitleBar, Window } from 'react-desktop/windows';

const electron = window.require('electron'); //Make sure to append window as babel will get confused by the require
const remote = electron.remote;

class ExampleNavPanel extends React.Component {
...
class ExampleWindow extends React.Component {
  constructor(props) {
    super(props)

    this.state = { isMaximized: false }

    this.toggleMaximize = this.toggleMaximize.bind(this) //Bind this to the function
...
ReactDOM.render(< ExampleWindow />,document.getElementById('root'))